...
class SkillLearningsCaptureServiceTest extends TestCase {
	...
	private function service(?RedactionService $redaction = null): SkillLearningsCaptureService {
		...
		return new class($this->objectService, $this->auditTrailMapper, $this->providerFactory, $this->budgetService, $redaction, new NullLogger()) extends SkillLearningsCaptureService {
			/**
