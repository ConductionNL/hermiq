...
- [x] Add the similarity endpoint and its group answer
...
- [x] Add the bands and the thresholds
- [x] Add the near-duplicate listing
...
- [x] Add the group object and the membership removal
...
- [x] Add a test asserting grouping changes no acknowledgement count
...
- [x] Read the declared key
- [x] Record the deciding method per membership
...
- [x] Add the window setting and the recording
...
- [x] Add the reasons record and its surface
- [x] Write each judgement to the audit trail

### Task 8: Verification
- [x] Unit tests for the three bands, the reversal and the untouched acknowledgement
      count
