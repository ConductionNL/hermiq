 ...
 * CnSupportDialog's "seen" flag) and by Hermiq's own Talk-delivery picker
 * (the `delivertarget` preference — see src/api/talk.js) that need to
 * persist a small per-user value cross-device without a bespoke endpoint
 * per feature.
 *
 * @category Controller
 ...
 *
 * @spec exclude Generic per-user preferences infra ported from
 *   nextcloud-app-template (shared CnSupportDialog contract) plus Hermiq's
 *   own Talk-delivery-target picker; no per-app behavioural spec of its own.
 */
class PreferencesController extends Controller
{
     ...
     *
     * @spec exclude Generic preferences read; no per-app behavioural spec.
     *
     * @NoAdminRequired
     * @NoCSRFRequired
     */
     ...
     * @return JSONResponse `{value: string|null}`.
     *
     * @spec exclude Generic preferences write; no per-app behavioural spec.
     *
     * @NoAdminRequired
     * @NoCSRFRequired
     */
